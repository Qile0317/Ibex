...
#'     \item *[Experimental]* A character vector of amino acid heavy and/or light
#'           chain sequences. If an element has no underscore, it's assumed to be
#'           heavy chain. If it is two sequences joined by an underscore, it is
#'           assumed to be the heavy and light chain. To represent pure light chains,
#'           format elements as None_AMINOACID
#'   }
